...
def plot_branin():
    ...
    with open('branin_good_10x64_16_train.p', 'rb') as f:
        traj_pts, traj_vls, _, _, _, _ = pkl.load(f)

    # with open('branin_400x64_16_train.p', 'rb') as f:
    with open('branin_test_128x64_16_eval.p', 'rb') as f:
        farzi_pts, farzi_vls, _, _, _, _ = pkl.load(f)

    with open('branin_test_3_128x64_16_eval.p', 'rb') as f:
        farzi_pts2, farzi_vls2, _, _, _, _ = pkl.load(f)

    # with open('0.5_True_0_last/123', 'rb') as f:
