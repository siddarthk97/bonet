...
do
  ...
  #python scripts/train_desbench_new.py --seed $seed --context_length 64 --epochs 75 --batch_size 128 --dataset $dataset  --experiment $exptname --dim 10 --task tf-bind-10 --heads 8 --layers 8 --discrete --vocab_size 4 1>outputs/tf-bind-10/new_$seed_retry.txt 2>&1 &
  python scripts/train_desbench_new.py --seed $seed --context_length 64 --epochs 65 --batch_size 128 --dataset $dataset  --experiment $exptname --dim 10 --task tf-bind-10 --heads 8 --layers 8 --discrete --vocab_size 4 
done
