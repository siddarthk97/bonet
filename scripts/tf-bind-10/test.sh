...
python3.9 scripts/test_desbench_new.py --seeds $seeds --context_length 64 --dataset $dataset --eval_dataset $test_dataset --experiment $exptname --dim 10 --task tf-bind-10 --cond_rtgs $rtgs --discrete --vocab_size 4 --heads 8 --layers 8 --init_len 64 --no_update_rtg
=======
exptname="sorted_with_32_layers"
dataset="tf-bind-10/tfbind10_sorted_4000x128_64_train.p"
test_dataset="tf-bind-10/tfbind10_sorted_128x128_64_eval.p"
rtgs="0.0 0.01 0.05 0.1 0.5"
seeds="123"

python scripts/test_desbench.py --seeds $seeds --context_length 64 --dataset $dataset --eval_dataset $test_dataset --experiment $exptname --dim 10 --task tf-bind-10 --cond_rtgs $rtgs --discrete --vocab_size 4 --layers 32 --init_len 64
>>>>>>> 952aca38e15f92b00fbf918f91a4bc2cdc74b45a
