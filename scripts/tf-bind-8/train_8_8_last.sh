...
do
  ...
  python scripts/train_desbench.py --seed $seed --context_length 64 --epochs 75 --batch_size 128  --dataset $dataset  --experiment $exptname --dim 8 --task tf-bind-8 --discrete --heads 8 --layers 8 --vocab_size 4 1>outputs/tf-bind-8/8h_8l_$seed.txt 2>&1 &
done
