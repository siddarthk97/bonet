...
python3.9 scripts/test_desbench_new.py --seeds $seeds --context_length 64 --dataset $dataset --eval_dataset $test_dataset --experiment $exptname --dim 8 --task tf-bind-8 --cond_rtgs $rtgs --discrete --init_len 64 --vocab_size 4 --heads 8 --layers 8 --no_update_rtg
