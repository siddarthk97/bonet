...
from mingpt.model_discrete import GPTDiscrete
from mingpt.model_discrete import GPTConfig as GPTConfigDiscrete
...
for j, seed in enumerate(args.seeds):
    ...
    for i, cond_rtg in enumerate(args.cond_rtgs):
        ...
        results = LogResult(exptname=args.task + f"/{args.experiment}/{k}_{cond_rtg}_" + str(update_rtg) + "_" + str(args.init_len) + "_" + args.model_stage)
        res = {}
